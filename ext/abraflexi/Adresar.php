 ...
 */
class Adresar extends \AbraFlexi\Adresar {
    ...
    public function convertOscData($customerData) {
        ...
        if (array_key_exists('customers_lastname', $customerData) && array_key_exists('customers_firstname',
            ...
            $adresarData['kod'] = \AbraFlexi\RO::uncode($this->getKod($kodSource));
        }
    ...
    public function oscCountryCode($countryID) {
        ...
        return empty($countryCode) || ($countryCode == 'null') ? [] : \AbraFlexi\RO::code($countryCode);
    }

    /**
     * Take SQL Data and prepare for use with AbraFlexi
     * 
