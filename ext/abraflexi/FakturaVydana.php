...
//        $invoiceData['popis']  = $orderData['orders_description'];
        ...
        $invoiceData['poznam']  = _('AbraFlexi import');
//        $invoiceData['kod']    = \AbraFlexi\RO::uncode($this->getKod($kodSource));
    ...
    public function insertToAbraFlexi($data = null)
    {
        ...
        $result = parent::insertToAbraFlexi($data);

        if ($this->responseStats['inserted'] == 1) {
            AbraFlexi\Priloha::addAttachmentFromFile($invoice,
