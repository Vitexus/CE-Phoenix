...
*/
define('HEADING_TITLE_AUTHOR_AM', 'by Jack York from <a href="http://www.oscommerce-solution.com/" target="_blank"><span style="font-family: Verdana, Arial, sans-serif; color: sienna; font-size: 12px;">oscommerce-solution.com</span></a>');
define('HEADING_TITLE_SUPPORT_THREAD_AM', '<a href="http://forums.oscommerce.com/topic/68866-article-manager-v1-0/" target="_blank"><span style="color: sienna;">(visit the support thread)</span></a>');
...
define('TABLE_HEADING_ARTICLE_ID', 'Article ID');
...
define('TEXT_BOX_ID_XREF_ACCOUNT','Account');
define('TEXT_BOX_ID_XREF_ARTICLES','Articles');
define('TEXT_BOX_ID_XREF_CONTACT_US','Contact_US');
define('TEXT_BOX_ID_XREF_INFOBOX','Information Box');
define('TEXT_BOX_ID_XREF_LINKS','Links');
define('TEXT_BOX_ID_XREF_OTHER','Other');
define('TEXT_BOX_ID_XREF_TEXT','Text');

define('TEXT_EDIT_INTRO', 'Please make any necessary changes');
define('TEXT_EDIT_TOPICS_ID', 'Topic ID:');
define('TEXT_EDIT_TOPICS_NAME', 'Topic Name:');
define('TEXT_EDIT_BOX_ID', 'Box ID');
...
define('TEXT_ARTICLE_BLOG_NO', 'No');
define('TEXT_ARTICLE_BLOG_YES', 'Yes');
define('TEXT_ARTICLES_BLOG_STATUS', 'Blog Article');
...
define('TEXT_ARTICLES_HTS_TITLE', 'HTS Title');
define('TEXT_ARTICLES_HTS_DESC', 'HTS Description');
define('TEXT_ARTICLES_HTS_KWORDS', 'HTS Keywords');
...
define('ERROR_CATALOG_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Error: Catalog images directory is not writeable: ' . DIR_FS_CATALOG . 'images/');
define('ERROR_CATALOG_IMAGE_DIRECTORY_DOES_NOT_EXIST', 'Error: Catalog images directory does not exist: ' . DIR_FS_CATALOG . 'images/');
...
define('IMAGE_AM_SAVE', 'Save');

define('ERROR_INVLAID_BOX_ID', 'Box ID is invalid');
define('ERROR_INVLAID_NAME', 'Name is invalid');
