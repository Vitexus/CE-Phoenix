...
define('JQUERY_DATEPICKER_I18N_CODE', 'cs'); // leave empty for en_US; see http://jqueryui.com/demos/datepicker/#localization pure:todo
...
define('CHECKOUT_BAR_DELIVERY', 'Dodání');
define('CHECKOUT_BAR_PAYMENT', 'Platba');
...
define('CATEGORY_CONTACT', 'Napište nám');
...
define('IMAGE_BUTTON_CONFIRM_ORDER', 'Potvrdit závaznou objednávku');
...
define('IMAGE_BUTTON_IN_CART', 'Koupit');
...
define('IMAGE_BUTTON_SEARCH', 'Vyhledat');
...
define('TEXT_GREETING_GUEST', 'Vítejte <span class="greetUser">návštěvníku!</span> Chcete se  <a href="%s"><u>přihlásit</u></a>? nebo teprve <a href="%s"><u>zaregistrovat</u></a>?'); 
...
define('TEXT_REQUIRED', '<span class="errorText">je nutné vyplnit</span>');
...
define('FORM_REQUIRED_INFORMATION', 'Nutno vyplnit');
...
// SEO Header Tags Reloaded
  //header titles
define('HEADER_CART_CONTENTS', '<i class="glyphicon fa-shopping-cart"></i> %s kusů<span class="caret"></span>');
define('HEADER_CART_NO_CONTENTS', '<i class="glyphicon fa-shopping-cart"></i><span class="hidden-lg hidden-md hidden-sm"> košík</span><span class="caret"></span>'); //pure:static version needed clickable statc cart if you go back to generated page - no idea about cart contents
define('HEADER_ACCOUNT_LOGGED_OUT', '<span class="hidden-sm"> přihlásit se/registrace</span> <span class="caret"></span>');
...
// CCGV
  ...
  define('TABLE_HEADING_CREDIT', '&nbsp;'); //Slevový kupón
...
define('ENTRY_COMPANY_NUMBER_TEXT_2', '');
...
define('CART','Košík');
define('CHECKOUT','Pokladna');
define('ACCOUNT','Můj účet');

//static pages
define('PRODUCTS_NEW_PAGE','novinky');
define('QUICK_SHOP_PAGE','quick-shop');
