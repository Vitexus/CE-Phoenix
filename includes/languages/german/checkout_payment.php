...
const NAVBAR_TITLE_2 = 'Zahlungsweise';

const HEADING_TITLE = 'Zahlungsweise';

const TABLE_HEADING_BILLING_ADDRESS = 'Rechnungsadresse';
define('TEXT_SELECTED_BILLING_DESTINATION',
    'Bitte wählen Sie aus Ihrem Adressbuch die gewünschte Rechnungsadresse für Ihre Bestellung aus.',
    true);
const TITLE_BILLING_ADDRESS = 'Rechnungsadresse:';

const TABLE_HEADING_PAYMENT_METHOD = 'Zahlungsweise';
define('TEXT_SELECT_PAYMENT_METHOD',
    'Bitte wählen Sie die gewünschte Zahlungsweise für Ihre Bestellung aus.',
    true);
...
define('TABLE_HEADING_COMMENTS',
    'Fügen Sie hier Ihre Anmerkungen zu dieser Bestellung ein');
