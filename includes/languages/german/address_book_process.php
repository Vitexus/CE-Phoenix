...
define('HEADING_TITLE_MODIFY_ENTRY', 'Adressbuch: Eintrag ändern');
define('HEADING_TITLE_DELETE_ENTRY', 'Adressbuch: Eintrag löschen');

define('DELETE_ADDRESS_TITLE', 'Eintrag löschen');
