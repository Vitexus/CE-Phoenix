...
define('TEXT_SEARCH_IN_DESCRIPTION', 'Vyhledávání v popisu produktů');
...
define('ENTRY_DATE_FROM', 'Datum přidání od:');
define('ENTRY_DATE_TO', 'Datum přidání do:');
...
define('HEADING_SEARCH_HELP', 'Pomoc s vyhledáváním');
...
define('ERROR_INVALID_TO_DATE', 'špatně datum Do.');
