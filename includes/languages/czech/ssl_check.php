...
define('NAVBAR_TITLE', 'Ochrana osobních údajů a zabezpečení');
define('HEADING_TITLE', 'Ochrana osobních údajů a zabezpečení');
...
define('BOX_INFORMATION_HEADING', 'Ochrana osobních údajů a zabezpečení');
