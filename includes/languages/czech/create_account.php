...
define('EMAIL_WELCOME',
    'Vítáme Vás v eshopu <strong>'.STORE_NAME.'</strong>.'."\n\n");
define('EMAIL_TEXT',
...
define('EMAIL_WARNING',
    '<strong>Pozor:</strong> Tento e-mail jste dostal(a) na základě registrace v našem obchodě. Pokud jste se v našem obchodě neregistroval(a), napište nám na adresu '.STORE_OWNER_EMAIL_ADDRESS.'.'."\n");
/*
 * ***********************************************************************
