...
class cm_pi_hall extends abstract_executable_module {

    const CONFIG_KEY_BASE = 'MODULE_CONTENT_PI_HALL_';
    ...
    public function execute() {
        ...
        $content_width = (int) MODULE_CONTENT_PI_HALL_CONTENT_WIDTH;
        $thumbnail_width = MODULE_CONTENT_PI_HALL_CONTENT_WIDTH_EACH;

        $pi_image = $pi_thumb = null;

        if (tep_not_null($product_info['products_image'])) {
            $album_name = sprintf(MODULE_CONTENT_PI_HALL_ALBUM_NAME, $product_info['products_name']);
            $album_exit = MODULE_CONTENT_PI_HALL_ALBUM_CLOSE;
            ...
            $modal_size = MODULE_CONTENT_PI_HALL_MODAL_SIZE;
    ...
    protected function get_parameters() {
        return [
            ...
            'MODULE_CONTENT_PI_HALL_MODAL_SIZE' => [
